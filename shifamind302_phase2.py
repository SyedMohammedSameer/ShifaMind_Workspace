...
print("="*80)
print("🚀 SHIFAMIND v302 PHASE 2: GAT + UMLS KNOWLEDGE GRAPH")
print("="*80)
...
print(f"📁 Loading from: {run_folders[0].name}")
...
if macro_f1 >= 0.2801:
    print("\n🎉 SUCCESS! Beat v301 Phase 1 baseline!")
elif macro_f1 >= 0.2536:
    print("\n✅ Improvement over v301 Phase 2!")
else:
    print("\n⚠️  Did not beat baseline. Consider:")
